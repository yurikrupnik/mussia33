# crossplane-kubernetes-by-hand-copy

A [timoni.sh](http://timoni.sh) module for deploying crossplane-kubernetes-by-hand-copy to Kubernetes clusters.
...
```shell
timoni -n default apply crossplane-kubernetes-by-hand-copy oci://<container-registry-url>
```
...
```shell
timoni -n default delete crossplane-kubernetes-by-hand-copy
```
