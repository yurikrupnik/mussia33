...
#SecretParameters: {
	...
	// +kubebuilder:validation:Optional
	secretNameRef?: null | v1.#Reference @go(SecretNameRef,*v1.Reference)

	// Selector for a Secret in secretmanager to populate secretName.
	// +kubebuilder:validation:Optional
	secretNameSelector?: null | v1.#Selector @go(SecretNameSelector,*v1.Selector)
}
...
#ServiceMetadataParameters: {
	...
	// +kubebuilder:validation:Optional
	namespaceRef?: null | v1.#Reference @go(NamespaceRef,*v1.Reference)

	// Selector for a Project in cloudplatform to populate namespace.
	// +kubebuilder:validation:Optional
	namespaceSelector?: null | v1.#Selector @go(NamespaceSelector,*v1.Selector)
}
