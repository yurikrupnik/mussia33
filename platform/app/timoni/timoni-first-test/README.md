...
A [timoni.sh](http://timoni.sh) module for deploying timoni-first-test to Kubernetes clusters.
...
```shell
timoni -n default apply timoni-first-test oci://<container-registry-url>
```
...
```shell
timoni -n default delete timoni-first-test
```
