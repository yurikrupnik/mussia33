...
A [timoni.sh](http://timoni.sh) module for deploying test-package to Kubernetes clusters.
...
```shell
timoni -n default apply test-package oci://<container-registry-url>
```
...
```shell
timoni -n default delete test-package
```
