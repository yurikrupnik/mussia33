...
export interface DomainSpecInitProvider {
   ...
   * while Elasticsearch has elasticsearch_version
   *
   * @schema DomainSpecInitProvider#engineVersion
   */
  readonly engineVersion?: string;
...
export interface DomainSpecInitProviderAdvancedSecurityOptions {
   ...
   * Whether Anonymous auth is enabled. Enables fine-grained access control on an existing domain. Ignored unless advanced_security_options are enabled. Can only be enabled on an existing domain.
   *
   * @schema DomainSpecInitProviderAdvancedSecurityOptions#anonymousAuthEnabled
   */
  readonly anonymousAuthEnabled?: boolean;
...
export interface DomainSamlOptionsSpecForProvider {
   ...
   * Name of the domain.
   *
   * @schema DomainSamlOptionsSpecForProvider#domainName
   */
  readonly domainName?: string;
   ...
   *
   * @schema DomainSamlOptionsSpecForProvider#domainNameRef
   */
  readonly domainNameRef?: DomainSamlOptionsSpecForProviderDomainNameRef;

  /**
   * Selector for a Domain in opensearch to populate domainName.
   *
   * @schema DomainSamlOptionsSpecForProvider#domainNameSelector
   */
  readonly domainNameSelector?: DomainSamlOptionsSpecForProviderDomainNameSelector;
...
export function toJson_DomainSamlOptionsSpecForProvider(obj: DomainSamlOptionsSpecForProvider | undefined): Record<string, any> | undefined {
  ...
  const result = {
    'domainName': obj.domainName,
    'domainNameRef': toJson_DomainSamlOptionsSpecForProviderDomainNameRef(obj.domainNameRef),
    'domainNameSelector': toJson_DomainSamlOptionsSpecForProviderDomainNameSelector(obj.domainNameSelector),
    'region': obj.region,
 ...
 * Reference to a Domain in opensearch to populate domainName.
 *
 * @schema DomainSamlOptionsSpecForProviderDomainNameRef
 */
export interface DomainSamlOptionsSpecForProviderDomainNameRef {
  /**
   * Name of the referenced object.
   *
   * @schema DomainSamlOptionsSpecForProviderDomainNameRef#name
   */
  readonly name: string;
   ...
   * Policies for referencing.
   *
   * @schema DomainSamlOptionsSpecForProviderDomainNameRef#policy
   */
  readonly policy?: DomainSamlOptionsSpecForProviderDomainNameRefPolicy;

}

/**
 * Converts an object of type 'DomainSamlOptionsSpecForProviderDomainNameRef' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_DomainSamlOptionsSpecForProviderDomainNameRef(obj: DomainSamlOptionsSpecForProviderDomainNameRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'policy': toJson_DomainSamlOptionsSpecForProviderDomainNameRefPolicy(obj.policy),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Selector for a Domain in opensearch to populate domainName.
 *
 * @schema DomainSamlOptionsSpecForProviderDomainNameSelector
 */
export interface DomainSamlOptionsSpecForProviderDomainNameSelector {
  /**
   * MatchControllerRef ensures an object with the same controller reference as the selecting object is selected.
   *
   * @schema DomainSamlOptionsSpecForProviderDomainNameSelector#matchControllerRef
   */
  readonly matchControllerRef?: boolean;
   ...
   * MatchLabels ensures an object with matching labels is selected.
   *
   * @schema DomainSamlOptionsSpecForProviderDomainNameSelector#matchLabels
   */
  readonly matchLabels?: { [key: string]: string };
   ...
   * Policies for selection.
   *
   * @schema DomainSamlOptionsSpecForProviderDomainNameSelector#policy
   */
  readonly policy?: DomainSamlOptionsSpecForProviderDomainNameSelectorPolicy;

}

/**
 * Converts an object of type 'DomainSamlOptionsSpecForProviderDomainNameSelector' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_DomainSamlOptionsSpecForProviderDomainNameSelector(obj: DomainSamlOptionsSpecForProviderDomainNameSelector | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'matchControllerRef': obj.matchControllerRef,
    'matchLabels': ((obj.matchLabels) === undefined) ? undefined : (Object.entries(obj.matchLabels).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
    'policy': toJson_DomainSamlOptionsSpecForProviderDomainNameSelectorPolicy(obj.policy),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Policies for referencing.
 *
 * @schema DomainSamlOptionsSpecForProviderDomainNameRefPolicy
 */
export interface DomainSamlOptionsSpecForProviderDomainNameRefPolicy {
  /**
   * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
   *
   * @schema DomainSamlOptionsSpecForProviderDomainNameRefPolicy#resolution
   */
  readonly resolution?: DomainSamlOptionsSpecForProviderDomainNameRefPolicyResolution;

  /**
   * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
   *
   * @schema DomainSamlOptionsSpecForProviderDomainNameRefPolicy#resolve
   */
  readonly resolve?: DomainSamlOptionsSpecForProviderDomainNameRefPolicyResolve;

}

/**
 * Converts an object of type 'DomainSamlOptionsSpecForProviderDomainNameRefPolicy' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_DomainSamlOptionsSpecForProviderDomainNameRefPolicy(obj: DomainSamlOptionsSpecForProviderDomainNameRefPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'resolution': obj.resolution,
    'resolve': obj.resolve,
 ...
 * Policies for selection.
 *
 * @schema DomainSamlOptionsSpecForProviderDomainNameSelectorPolicy
 */
export interface DomainSamlOptionsSpecForProviderDomainNameSelectorPolicy {
  /**
   * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
   *
   * @schema DomainSamlOptionsSpecForProviderDomainNameSelectorPolicy#resolution
   */
  readonly resolution?: DomainSamlOptionsSpecForProviderDomainNameSelectorPolicyResolution;

  /**
   * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
   *
   * @schema DomainSamlOptionsSpecForProviderDomainNameSelectorPolicy#resolve
   */
  readonly resolve?: DomainSamlOptionsSpecForProviderDomainNameSelectorPolicyResolve;

}

/**
 * Converts an object of type 'DomainSamlOptionsSpecForProviderDomainNameSelectorPolicy' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_DomainSamlOptionsSpecForProviderDomainNameSelectorPolicy(obj: DomainSamlOptionsSpecForProviderDomainNameSelectorPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'resolution': obj.resolution,
    'resolve': obj.resolve,
 ...
 * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
 *
 * @schema DomainSamlOptionsSpecForProviderDomainNameRefPolicyResolution
 */
export enum DomainSamlOptionsSpecForProviderDomainNameRefPolicyResolution {
  /** Required */
  REQUIRED = "Required",
  /** Optional */
  OPTIONAL = "Optional",
 ...
 * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
 *
 * @schema DomainSamlOptionsSpecForProviderDomainNameRefPolicyResolve
 */
export enum DomainSamlOptionsSpecForProviderDomainNameRefPolicyResolve {
  /** Always */
  ALWAYS = "Always",
  /** IfNotPresent */
  IF_NOT_PRESENT = "IfNotPresent",
 ...
 * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
 *
 * @schema DomainSamlOptionsSpecForProviderDomainNameSelectorPolicyResolution
 */
export enum DomainSamlOptionsSpecForProviderDomainNameSelectorPolicyResolution {
  /** Required */
  REQUIRED = "Required",
  /** Optional */
  OPTIONAL = "Optional",
 ...
 * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
 *
 * @schema DomainSamlOptionsSpecForProviderDomainNameSelectorPolicyResolve
 */
export enum DomainSamlOptionsSpecForProviderDomainNameSelectorPolicyResolve {
  /** Always */
  ALWAYS = "Always",
  /** IfNotPresent */
  IF_NOT_PRESENT = "IfNotPresent",
