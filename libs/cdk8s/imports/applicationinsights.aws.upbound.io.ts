...
export interface ApplicationSpecInitProvider {
   ...
   * Indicates whether Application Insights automatically configures unmonitored resources in the resource group.
   *
   * @schema ApplicationSpecInitProvider#autoConfigEnabled
   */
  readonly autoConfigEnabled?: boolean;
   ...
   * Configures all of the resources in the resource group by applying the recommended configurations.
   *
   * @schema ApplicationSpecInitProvider#autoCreate
   */
  readonly autoCreate?: boolean;
   ...
   * Indicates whether Application Insights can listen to CloudWatch events for the application resources, such as instance terminated, failed deployment, and others.
   *
   * @schema ApplicationSpecInitProvider#cweMonitorEnabled
   */
  readonly cweMonitorEnabled?: boolean;
   ...
   * Application Insights can create applications based on a resource group or on an account. To create an account-based application using all of the resources in the account, set this parameter to ACCOUNT_BASED.
   *
   * @schema ApplicationSpecInitProvider#groupingType
   */
  readonly groupingType?: string;
   ...
   * When set to true, creates opsItems for any problems detected on an application.
   *
   * @schema ApplicationSpecInitProvider#opsCenterEnabled
   */
  readonly opsCenterEnabled?: boolean;
   ...
   * SNS topic provided to Application Insights that is associated to the created opsItem. Allows you to receive notifications for updates to the opsItem.
   *
   * @schema ApplicationSpecInitProvider#opsItemSnsTopicArn
   */
  readonly opsItemSnsTopicArn?: string;
