...
export interface ProfileSpec {
   ...
   *
   * @schema ProfileSpec#managementPolicy
   */
  readonly managementPolicy?: ProfileSpecManagementPolicy;
   ...
   *
   * @schema ProfileSpec#providerRef
   */
  readonly providerRef?: ProfileSpecProviderRef;
...
export function toJson_ProfileSpec(obj: ProfileSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'providerRef': toJson_ProfileSpecProviderRef(obj.providerRef),
 ...
 * THIS IS AN ALPHA FIELD. Do not use it in production. It is not honored unless the relevant Crossplane feature flag is enabled, and may be changed or removed without notice. ManagementPolicy specifies the level of control Crossplane has over the managed external resource. This field is planned to replace the DeletionPolicy field in a future release. Currently, both could be set independently and non-default values would be honored if the feature flag is enabled. See the design doc for more information: https://github.com/crossplane/crossplane/blob/499895a25d1a1a0ba1604944ef98ac7a1a71f197/design/design-doc-observe-only-resources.md?plain=1#L223
 *
 * @schema ProfileSpecManagementPolicy
 */
export enum ProfileSpecManagementPolicy {
  /** FullControl */
 ...
 * ProviderReference specifies the provider that will be used to create, observe, update, and delete this managed resource. Deprecated: Please use ProviderConfigReference, i.e. `providerConfigRef`
 *
 * @schema ProfileSpecProviderRef
 */
export interface ProfileSpecProviderRef {
  /**
   * Name of the referenced object.
   *
   * @schema ProfileSpecProviderRef#name
   */
  readonly name: string;
   ...
   * Policies for referencing.
   *
   * @schema ProfileSpecProviderRef#policy
   */
  readonly policy?: ProfileSpecProviderRefPolicy;

}

/**
 * Converts an object of type 'ProfileSpecProviderRef' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ProfileSpecProviderRef(obj: ProfileSpecProviderRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'policy': toJson_ProfileSpecProviderRefPolicy(obj.policy),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Policies for referencing.
 *
 * @schema ProfileSpecProviderRefPolicy
 */
export interface ProfileSpecProviderRefPolicy {
  /**
   * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
   *
   * @schema ProfileSpecProviderRefPolicy#resolution
   */
  readonly resolution?: ProfileSpecProviderRefPolicyResolution;

  /**
   * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
   *
   * @schema ProfileSpecProviderRefPolicy#resolve
   */
  readonly resolve?: ProfileSpecProviderRefPolicyResolve;

}

/**
 * Converts an object of type 'ProfileSpecProviderRefPolicy' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ProfileSpecProviderRefPolicy(obj: ProfileSpecProviderRefPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'resolution': obj.resolution,
    'resolve': obj.resolve,
 ...
 * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
 *
 * @schema ProfileSpecProviderRefPolicyResolution
 */
export enum ProfileSpecProviderRefPolicyResolution {
  /** Required */
  REQUIRED = "Required",
  /** Optional */
  OPTIONAL = "Optional",
 ...
 * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
 *
 * @schema ProfileSpecProviderRefPolicyResolve
 */
export enum ProfileSpecProviderRefPolicyResolve {
  /** Always */
  ALWAYS = "Always",
  /** IfNotPresent */
  IF_NOT_PRESENT = "IfNotPresent",
