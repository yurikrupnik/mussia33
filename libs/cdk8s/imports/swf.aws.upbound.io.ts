...
export interface DomainSpecForProvider {
   ...
   *
   * @schema DomainSpecForProvider#description
   */
   ...
   *
   * @schema DomainSpecForProvider#workflowExecutionRetentionPeriodInDays
   */
...
export interface DomainSpecInitProvider {
   ...
   * The domain description.
   *
   * @schema DomainSpecInitProvider#description
   */
  readonly description?: string;
   ...
   * Length of time that SWF will continue to retain information about the workflow execution after the workflow execution is complete, must be between 0 and 90 days.
   *
   * @schema DomainSpecInitProvider#workflowExecutionRetentionPeriodInDays
   */
  readonly workflowExecutionRetentionPeriodInDays?: string;
