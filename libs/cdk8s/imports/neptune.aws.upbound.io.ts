...
export interface ClusterSpecInitProvider {
   ...
   * A list of the log types this DB cluster is configured to export to Cloudwatch Logs. Currently only supports audit.
   *
   * @schema ClusterSpecInitProvider#enableCloudwatchLogsExports
   */
  readonly enableCloudwatchLogsExports?: string[];
   ...
   * The name of the DB parameter group to apply to all instances of the DB cluster.
   *
   * @schema ClusterSpecInitProvider#neptuneInstanceParameterGroupName
   */
  readonly neptuneInstanceParameterGroupName?: string;
...
export interface ClusterEndpointSpecInitProvider {
   ...
   * The type of the endpoint. One of: READER, WRITER, ANY.
   *
   * @schema ClusterEndpointSpecInitProvider#endpointType
   */
  readonly endpointType?: string;
...
export interface ClusterInstanceSpecInitProvider {
   ...
   *
   * @default 8182.
   * @schema ClusterInstanceSpecInitProvider#port
   */
  readonly port?: number;
