...
export interface ByteMatchSetSpec {
   ...
   *
   * @schema ByteMatchSetSpec#initProvider
   */
  readonly initProvider?: ByteMatchSetSpecInitProvider;
   ...
   *
   * @schema ByteMatchSetSpec#managementPolicies
   */
  readonly managementPolicies?: ByteMatchSetSpecManagementPolicies[];
...
export function toJson_ByteMatchSetSpec(obj: ByteMatchSetSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'initProvider': toJson_ByteMatchSetSpecInitProvider(obj.initProvider),
 ...
 * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
 *
 * @schema ByteMatchSetSpecInitProvider
 */
export interface ByteMatchSetSpecInitProvider {
  /**
   * Specifies the bytes (typically a string that corresponds with ASCII characters) that you want to search for in web requests, the location in requests that you want to search, and other settings.
   *
   * @schema ByteMatchSetSpecInitProvider#byteMatchTuples
   */
  readonly byteMatchTuples?: ByteMatchSetSpecInitProviderByteMatchTuples[];

  /**
   * The name or description of the Byte Match Set.
   *
   * @schema ByteMatchSetSpecInitProvider#name
   */
  readonly name?: string;
...
/**
 * Converts an object of type 'ByteMatchSetSpecInitProvider' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ByteMatchSetSpecInitProvider(obj: ByteMatchSetSpecInitProvider | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'byteMatchTuples': obj.byteMatchTuples?.map(y => toJson_ByteMatchSetSpecInitProviderByteMatchTuples(y)),
    'name': obj.name,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
 ...
 *
 * @schema ByteMatchSetSpecManagementPolicies
 */
export enum ByteMatchSetSpecManagementPolicies {
  /** Observe */
  OBSERVE = "Observe",
  /** Create */
  CREATE = "Create",
...
/**
 * @schema ByteMatchSetSpecInitProviderByteMatchTuples
 */
export interface ByteMatchSetSpecInitProviderByteMatchTuples {
  /**
   * The part of a web request that you want to search, such as a specified header or a query string.
   *
   * @schema ByteMatchSetSpecInitProviderByteMatchTuples#fieldToMatch
   */
  readonly fieldToMatch?: ByteMatchSetSpecInitProviderByteMatchTuplesFieldToMatch[];

  /**
   * Within the portion of a web request that you want to search (for example, in the query string, if any), specify where you want to search. e.g., CONTAINS, CONTAINS_WORD or EXACTLY. See docs for all supported values.
   *
   * @schema ByteMatchSetSpecInitProviderByteMatchTuples#positionalConstraint
   */
  readonly positionalConstraint?: string;
   ...
   * The value that you want to search for within the field specified by field_to_match, e.g., badrefer1. See docs for all supported values.
   *
   * @schema ByteMatchSetSpecInitProviderByteMatchTuples#targetString
   */
  readonly targetString?: string;
   ...
   * Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the transformation on target_string before inspecting a request for a match. e.g., CMD_LINE, HTML_ENTITY_DECODE or NONE. See docs for all supported values.
   *
   * @schema ByteMatchSetSpecInitProviderByteMatchTuples#textTransformation
   */
  readonly textTransformation?: string;
...
/**
 * Converts an object of type 'ByteMatchSetSpecInitProviderByteMatchTuples' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ByteMatchSetSpecInitProviderByteMatchTuples(obj: ByteMatchSetSpecInitProviderByteMatchTuples | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'fieldToMatch': obj.fieldToMatch?.map(y => toJson_ByteMatchSetSpecInitProviderByteMatchTuplesFieldToMatch(y)),
    'positionalConstraint': obj.positionalConstraint,
    'targetString': obj.targetString,
    'textTransformation': obj.textTransformation,
  };
...
/**
 * @schema ByteMatchSetSpecInitProviderByteMatchTuplesFieldToMatch
 */
export interface ByteMatchSetSpecInitProviderByteMatchTuplesFieldToMatch {
  /**
   * When type is HEADER, enter the name of the header that you want to search, e.g., User-Agent or Referer. If type is any other value, omit this field.
   *
   * @schema ByteMatchSetSpecInitProviderByteMatchTuplesFieldToMatch#data
   */
  readonly data?: string;
   ...
   * The part of the web request that you want AWS WAF to search for a specified string. e.g., HEADER, METHOD or BODY. See docs for all supported values.
   *
   * @schema ByteMatchSetSpecInitProviderByteMatchTuplesFieldToMatch#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'ByteMatchSetSpecInitProviderByteMatchTuplesFieldToMatch' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ByteMatchSetSpecInitProviderByteMatchTuplesFieldToMatch(obj: ByteMatchSetSpecInitProviderByteMatchTuplesFieldToMatch | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'data': obj.data,
    'type': obj.type,
...
export interface GeoMatchSetSpec {
   ...
   * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
   *
   * @schema GeoMatchSetSpec#initProvider
   */
  readonly initProvider?: GeoMatchSetSpecInitProvider;

  /**
   * THIS IS A BETA FIELD. It is on by default but can be opted out through a Crossplane feature flag. ManagementPolicies specify the array of actions Crossplane is allowed to take on the managed and external resources. This field is planned to replace the DeletionPolicy field in a future release. Currently, both could be set independently and non-default values would be honored if the feature flag is enabled. If both are custom, the DeletionPolicy field will be ignored. See the design doc for more information: https://github.com/crossplane/crossplane/blob/499895a25d1a1a0ba1604944ef98ac7a1a71f197/design/design-doc-observe-only-resources.md?plain=1#L223 and this one: https://github.com/crossplane/crossplane/blob/444267e84783136daa93568b364a5f01228cacbe/design/one-pager-ignore-changes.md
   *
   * @schema GeoMatchSetSpec#managementPolicies
   */
  readonly managementPolicies?: GeoMatchSetSpecManagementPolicies[];
...
export function toJson_GeoMatchSetSpec(obj: GeoMatchSetSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'initProvider': toJson_GeoMatchSetSpecInitProvider(obj.initProvider),
    'managementPolicies': obj.managementPolicies?.map(y => y),
 ...
 * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
 *
 * @schema GeoMatchSetSpecInitProvider
 */
export interface GeoMatchSetSpecInitProvider {
  /**
   * The GeoMatchConstraint objects which contain the country that you want AWS WAF to search for.
   *
   * @schema GeoMatchSetSpecInitProvider#geoMatchConstraint
   */
  readonly geoMatchConstraint?: GeoMatchSetSpecInitProviderGeoMatchConstraint[];

  /**
   * The name or description of the GeoMatchSet.
   *
   * @schema GeoMatchSetSpecInitProvider#name
   */
  readonly name?: string;
...
/**
 * Converts an object of type 'GeoMatchSetSpecInitProvider' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_GeoMatchSetSpecInitProvider(obj: GeoMatchSetSpecInitProvider | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'geoMatchConstraint': obj.geoMatchConstraint?.map(y => toJson_GeoMatchSetSpecInitProviderGeoMatchConstraint(y)),
    'name': obj.name,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
 ...
 * A ManagementAction represents an action that the Crossplane controllers can take on an external resource.
 *
 * @schema GeoMatchSetSpecManagementPolicies
 */
export enum GeoMatchSetSpecManagementPolicies {
  /** Observe */
  OBSERVE = "Observe",
  /** Create */
  CREATE = "Create",
...
/**
 * @schema GeoMatchSetSpecInitProviderGeoMatchConstraint
 */
export interface GeoMatchSetSpecInitProviderGeoMatchConstraint {
  /**
   * The type of geographical area you want AWS WAF to search for. Currently Country is the only valid value.
   *
   * @schema GeoMatchSetSpecInitProviderGeoMatchConstraint#type
   */
  readonly type?: string;
   ...
   * The country that you want AWS WAF to search for. This is the two-letter country code, e.g., US, CA, RU, CN, etc. See docs for all supported values.
   *
   * @schema GeoMatchSetSpecInitProviderGeoMatchConstraint#value
   */
  readonly value?: string;
...
/**
 * Converts an object of type 'GeoMatchSetSpecInitProviderGeoMatchConstraint' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_GeoMatchSetSpecInitProviderGeoMatchConstraint(obj: GeoMatchSetSpecInitProviderGeoMatchConstraint | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'type': obj.type,
    'value': obj.value,
...
export interface IpSetSpecForProvider {
   ...
   *
   * @schema IpSetSpecForProvider#ipSetDescriptors
   */
  readonly ipSetDescriptors?: IpSetSpecForProviderIpSetDescriptors[];
...
export function toJson_IpSetSpecForProvider(obj: IpSetSpecForProvider | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'ipSetDescriptors': obj.ipSetDescriptors?.map(y => toJson_IpSetSpecForProviderIpSetDescriptors(y)),
    'name': obj.name,
    'region': obj.region,
  };
  // filter undefined values
...
export interface IpSetSpecInitProvider {
   ...
   * One or more pairs specifying the IP address type (IPV4 or IPV6) and the IP address range (in CIDR format) from which web requests originate.
   *
   * @schema IpSetSpecInitProvider#ipSetDescriptors
   */
  readonly ipSetDescriptors?: IpSetSpecInitProviderIpSetDescriptors[];
...
export function toJson_IpSetSpecInitProvider(obj: IpSetSpecInitProvider | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'ipSetDescriptors': obj.ipSetDescriptors?.map(y => toJson_IpSetSpecInitProviderIpSetDescriptors(y)),
    'name': obj.name,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
...
/**
 * @schema IpSetSpecForProviderIpSetDescriptors
 */
export interface IpSetSpecForProviderIpSetDescriptors {
  /**
   * Type of the IP address - IPV4 or IPV6.
   *
   * @schema IpSetSpecForProviderIpSetDescriptors#type
   */
  readonly type?: string;
   ...
   *
   * @schema IpSetSpecForProviderIpSetDescriptors#value
   */
  readonly value?: string;
...
/**
 * Converts an object of type 'IpSetSpecForProviderIpSetDescriptors' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_IpSetSpecForProviderIpSetDescriptors(obj: IpSetSpecForProviderIpSetDescriptors | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'type': obj.type,
    'value': obj.value,
...
/**
 * @schema IpSetSpecInitProviderIpSetDescriptors
 */
export interface IpSetSpecInitProviderIpSetDescriptors {
  /**
   * Type of the IP address - IPV4 or IPV6.
   *
   * @schema IpSetSpecInitProviderIpSetDescriptors#type
   */
  readonly type?: string;
   ...
   * An IPv4 or IPv6 address specified via CIDR notationE.g., 192.0.2.44/32 or 1111:0000:0000:0000:0000:0000:0000:0000/64
   *
   * @schema IpSetSpecInitProviderIpSetDescriptors#value
   */
  readonly value?: string;
...
/**
 * Converts an object of type 'IpSetSpecInitProviderIpSetDescriptors' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_IpSetSpecInitProviderIpSetDescriptors(obj: IpSetSpecInitProviderIpSetDescriptors | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'type': obj.type,
    'value': obj.value,
...
export interface RateBasedRuleSpec {
   ...
   * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
   *
   * @schema RateBasedRuleSpec#initProvider
   */
  readonly initProvider?: RateBasedRuleSpecInitProvider;

  /**
   * THIS IS A BETA FIELD. It is on by default but can be opted out through a Crossplane feature flag. ManagementPolicies specify the array of actions Crossplane is allowed to take on the managed and external resources. This field is planned to replace the DeletionPolicy field in a future release. Currently, both could be set independently and non-default values would be honored if the feature flag is enabled. If both are custom, the DeletionPolicy field will be ignored. See the design doc for more information: https://github.com/crossplane/crossplane/blob/499895a25d1a1a0ba1604944ef98ac7a1a71f197/design/design-doc-observe-only-resources.md?plain=1#L223 and this one: https://github.com/crossplane/crossplane/blob/444267e84783136daa93568b364a5f01228cacbe/design/one-pager-ignore-changes.md
   *
   * @schema RateBasedRuleSpec#managementPolicies
   */
  readonly managementPolicies?: RateBasedRuleSpecManagementPolicies[];
...
export function toJson_RateBasedRuleSpec(obj: RateBasedRuleSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'initProvider': toJson_RateBasedRuleSpecInitProvider(obj.initProvider),
    'managementPolicies': obj.managementPolicies?.map(y => y),
...
export interface RateBasedRuleSpecForProvider {
   ...
   *
   * @schema RateBasedRuleSpecForProvider#predicates
   */
  readonly predicates?: RateBasedRuleSpecForProviderPredicates[];
...
export function toJson_RateBasedRuleSpecForProvider(obj: RateBasedRuleSpecForProvider | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'name': obj.name,
    'predicates': obj.predicates?.map(y => toJson_RateBasedRuleSpecForProviderPredicates(y)),
    'rateKey': obj.rateKey,
 ...
 * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
 *
 * @schema RateBasedRuleSpecInitProvider
 */
export interface RateBasedRuleSpecInitProvider {
  /**
   * The name or description for the Amazon CloudWatch metric of this rule.
   *
   * @schema RateBasedRuleSpecInitProvider#metricName
   */
  readonly metricName?: string;
   ...
   * The name or description of the rule.
   *
   * @schema RateBasedRuleSpecInitProvider#name
   */
  readonly name?: string;
   ...
   * The objects to include in a rule (documented below).
   *
   * @schema RateBasedRuleSpecInitProvider#predicates
   */
  readonly predicates?: RateBasedRuleSpecInitProviderPredicates[];

  /**
   * Valid value is IP.
   *
   * @schema RateBasedRuleSpecInitProvider#rateKey
   */
  readonly rateKey?: string;
   ...
   * The maximum number of requests, which have an identical value in the field specified by the RateKey, allowed in a five-minute period. Minimum value is 100.
   *
   * @schema RateBasedRuleSpecInitProvider#rateLimit
   */
  readonly rateLimit?: number;
   ...
   * Key-value map of resource tags.
   *
   * @schema RateBasedRuleSpecInitProvider#tags
   */
  readonly tags?: { [key: string]: string };
...
/**
 * Converts an object of type 'RateBasedRuleSpecInitProvider' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RateBasedRuleSpecInitProvider(obj: RateBasedRuleSpecInitProvider | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'metricName': obj.metricName,
    'name': obj.name,
    'predicates': obj.predicates?.map(y => toJson_RateBasedRuleSpecInitProviderPredicates(y)),
    'rateKey': obj.rateKey,
    'rateLimit': obj.rateLimit,
    'tags': ((obj.tags) === undefined) ? undefined : (Object.entries(obj.tags).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
  };
 ...
 * A ManagementAction represents an action that the Crossplane controllers can take on an external resource.
 *
 * @schema RateBasedRuleSpecManagementPolicies
 */
export enum RateBasedRuleSpecManagementPolicies {
  /** Observe */
  OBSERVE = "Observe",
  /** Create */
  CREATE = "Create",
...
/**
 * @schema RateBasedRuleSpecForProviderPredicates
 */
export interface RateBasedRuleSpecForProviderPredicates {
  /**
   * A unique identifier for a predicate in the rule, such as Byte Match Set ID or IPSet ID.
   *
   * @schema RateBasedRuleSpecForProviderPredicates#dataId
   */
   ...
   *
   * @schema RateBasedRuleSpecForProviderPredicates#dataIdRef
   */
  readonly dataIdRef?: RateBasedRuleSpecForProviderPredicatesDataIdRef;

  /**
   * Selector for a IPSet in waf to populate dataId.
   *
   * @schema RateBasedRuleSpecForProviderPredicates#dataIdSelector
   */
  readonly dataIdSelector?: RateBasedRuleSpecForProviderPredicatesDataIdSelector;
   ...
   *
   * @schema RateBasedRuleSpecForProviderPredicates#negated
   */
   ...
   *
   * @schema RateBasedRuleSpecForProviderPredicates#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'RateBasedRuleSpecForProviderPredicates' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RateBasedRuleSpecForProviderPredicates(obj: RateBasedRuleSpecForProviderPredicates | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'dataId': obj.dataId,
    'dataIdRef': toJson_RateBasedRuleSpecForProviderPredicatesDataIdRef(obj.dataIdRef),
    'dataIdSelector': toJson_RateBasedRuleSpecForProviderPredicatesDataIdSelector(obj.dataIdSelector),
    'negated': obj.negated,
    'type': obj.type,
  };
  // filter undefined values
...
/**
 * @schema RateBasedRuleSpecInitProviderPredicates
 */
export interface RateBasedRuleSpecInitProviderPredicates {
  /**
   * Set this to false if you want to allow, block, or count requests based on the settings in the specified ByteMatchSet, IPSet, SqlInjectionMatchSet, XssMatchSet, or SizeConstraintSet. For example, if an IPSet includes the IP address 192.0.2.44, AWS WAF will allow or block requests based on that IP address. If set to true, AWS WAF will allow, block, or count requests based on all IP addresses except 192.0.2.44.
   *
   * @schema RateBasedRuleSpecInitProviderPredicates#negated
   */
  readonly negated?: boolean;
   ...
   * The type of predicate in a rule. Valid values: ByteMatch, GeoMatch, IPMatch, RegexMatch, SizeConstraint, SqlInjectionMatch, or XssMatch.
   *
   * @schema RateBasedRuleSpecInitProviderPredicates#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'RateBasedRuleSpecInitProviderPredicates' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RateBasedRuleSpecInitProviderPredicates(obj: RateBasedRuleSpecInitProviderPredicates | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'negated': obj.negated,
    'type': obj.type,
 ...
 * Reference to a IPSet in waf to populate dataId.
 *
 * @schema RateBasedRuleSpecForProviderPredicatesDataIdRef
 */
export interface RateBasedRuleSpecForProviderPredicatesDataIdRef {
  /**
   * Name of the referenced object.
   *
   * @schema RateBasedRuleSpecForProviderPredicatesDataIdRef#name
   */
  readonly name: string;
   ...
   * Policies for referencing.
   *
   * @schema RateBasedRuleSpecForProviderPredicatesDataIdRef#policy
   */
  readonly policy?: RateBasedRuleSpecForProviderPredicatesDataIdRefPolicy;

}

/**
 * Converts an object of type 'RateBasedRuleSpecForProviderPredicatesDataIdRef' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RateBasedRuleSpecForProviderPredicatesDataIdRef(obj: RateBasedRuleSpecForProviderPredicatesDataIdRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'policy': toJson_RateBasedRuleSpecForProviderPredicatesDataIdRefPolicy(obj.policy),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Selector for a IPSet in waf to populate dataId.
 *
 * @schema RateBasedRuleSpecForProviderPredicatesDataIdSelector
 */
export interface RateBasedRuleSpecForProviderPredicatesDataIdSelector {
  /**
   * MatchControllerRef ensures an object with the same controller reference as the selecting object is selected.
   *
   * @schema RateBasedRuleSpecForProviderPredicatesDataIdSelector#matchControllerRef
   */
   ...
   *
   * @schema RateBasedRuleSpecForProviderPredicatesDataIdSelector#matchLabels
   */
   ...
   *
   * @schema RateBasedRuleSpecForProviderPredicatesDataIdSelector#policy
   */
  readonly policy?: RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicy;

}

/**
 * Converts an object of type 'RateBasedRuleSpecForProviderPredicatesDataIdSelector' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RateBasedRuleSpecForProviderPredicatesDataIdSelector(obj: RateBasedRuleSpecForProviderPredicatesDataIdSelector | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'matchControllerRef': obj.matchControllerRef,
    'matchLabels': ((obj.matchLabels) === undefined) ? undefined : (Object.entries(obj.matchLabels).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
    'policy': toJson_RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicy(obj.policy),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Policies for referencing.
 *
 * @schema RateBasedRuleSpecForProviderPredicatesDataIdRefPolicy
 */
export interface RateBasedRuleSpecForProviderPredicatesDataIdRefPolicy {
  /**
   * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
   *
   * @schema RateBasedRuleSpecForProviderPredicatesDataIdRefPolicy#resolution
   */
  readonly resolution?: RateBasedRuleSpecForProviderPredicatesDataIdRefPolicyResolution;

  /**
   * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
   *
   * @schema RateBasedRuleSpecForProviderPredicatesDataIdRefPolicy#resolve
   */
  readonly resolve?: RateBasedRuleSpecForProviderPredicatesDataIdRefPolicyResolve;

}

/**
 * Converts an object of type 'RateBasedRuleSpecForProviderPredicatesDataIdRefPolicy' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RateBasedRuleSpecForProviderPredicatesDataIdRefPolicy(obj: RateBasedRuleSpecForProviderPredicatesDataIdRefPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'resolution': obj.resolution,
    'resolve': obj.resolve,
 ...
 * Policies for selection.
 *
 * @schema RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicy
 */
export interface RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicy {
  /**
   * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
   *
   * @schema RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicy#resolution
   */
  readonly resolution?: RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicyResolution;

  /**
   * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
   *
   * @schema RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicy#resolve
   */
  readonly resolve?: RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicyResolve;

}

/**
 * Converts an object of type 'RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicy' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicy(obj: RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'resolution': obj.resolution,
    'resolve': obj.resolve,
 ...
 * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
 *
 * @schema RateBasedRuleSpecForProviderPredicatesDataIdRefPolicyResolution
 */
export enum RateBasedRuleSpecForProviderPredicatesDataIdRefPolicyResolution {
  /** Required */
  REQUIRED = "Required",
  /** Optional */
  OPTIONAL = "Optional",
 ...
 * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
 *
 * @schema RateBasedRuleSpecForProviderPredicatesDataIdRefPolicyResolve
 */
export enum RateBasedRuleSpecForProviderPredicatesDataIdRefPolicyResolve {
  /** Always */
  ALWAYS = "Always",
  /** IfNotPresent */
  IF_NOT_PRESENT = "IfNotPresent",
 ...
 * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
 *
 * @schema RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicyResolution
 */
export enum RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicyResolution {
  /** Required */
  REQUIRED = "Required",
  /** Optional */
  OPTIONAL = "Optional",
 ...
 * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
 *
 * @schema RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicyResolve
 */
export enum RateBasedRuleSpecForProviderPredicatesDataIdSelectorPolicyResolve {
  /** Always */
  ALWAYS = "Always",
  /** IfNotPresent */
  IF_NOT_PRESENT = "IfNotPresent",
...
export interface RegexMatchSetSpec {
   ...
   * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
   *
   * @schema RegexMatchSetSpec#initProvider
   */
  readonly initProvider?: RegexMatchSetSpecInitProvider;

  /**
   * THIS IS A BETA FIELD. It is on by default but can be opted out through a Crossplane feature flag. ManagementPolicies specify the array of actions Crossplane is allowed to take on the managed and external resources. This field is planned to replace the DeletionPolicy field in a future release. Currently, both could be set independently and non-default values would be honored if the feature flag is enabled. If both are custom, the DeletionPolicy field will be ignored. See the design doc for more information: https://github.com/crossplane/crossplane/blob/499895a25d1a1a0ba1604944ef98ac7a1a71f197/design/design-doc-observe-only-resources.md?plain=1#L223 and this one: https://github.com/crossplane/crossplane/blob/444267e84783136daa93568b364a5f01228cacbe/design/one-pager-ignore-changes.md
   *
   * @schema RegexMatchSetSpec#managementPolicies
   */
  readonly managementPolicies?: RegexMatchSetSpecManagementPolicies[];
...
export function toJson_RegexMatchSetSpec(obj: RegexMatchSetSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'initProvider': toJson_RegexMatchSetSpecInitProvider(obj.initProvider),
    'managementPolicies': obj.managementPolicies?.map(y => y),
 ...
 * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
 *
 * @schema RegexMatchSetSpecInitProvider
 */
export interface RegexMatchSetSpecInitProvider {
  /**
   * The name or description of the Regex Match Set.
   *
   * @schema RegexMatchSetSpecInitProvider#name
   */
  readonly name?: string;
   ...
   * The regular expression pattern that you want AWS WAF to search for in web requests, the location in requests that you want AWS WAF to search, and other settings. See below.
   *
   * @schema RegexMatchSetSpecInitProvider#regexMatchTuple
   */
  readonly regexMatchTuple?: RegexMatchSetSpecInitProviderRegexMatchTuple[];

}

/**
 * Converts an object of type 'RegexMatchSetSpecInitProvider' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RegexMatchSetSpecInitProvider(obj: RegexMatchSetSpecInitProvider | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'regexMatchTuple': obj.regexMatchTuple?.map(y => toJson_RegexMatchSetSpecInitProviderRegexMatchTuple(y)),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * A ManagementAction represents an action that the Crossplane controllers can take on an external resource.
 *
 * @schema RegexMatchSetSpecManagementPolicies
 */
export enum RegexMatchSetSpecManagementPolicies {
  /** Observe */
  OBSERVE = "Observe",
  /** Create */
  CREATE = "Create",
...
/**
 * @schema RegexMatchSetSpecInitProviderRegexMatchTuple
 */
export interface RegexMatchSetSpecInitProviderRegexMatchTuple {
  /**
   * The part of a web request that you want to search, such as a specified header or a query string.
   *
   * @schema RegexMatchSetSpecInitProviderRegexMatchTuple#fieldToMatch
   */
  readonly fieldToMatch?: RegexMatchSetSpecInitProviderRegexMatchTupleFieldToMatch[];

  /**
   * Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. e.g., CMD_LINE, HTML_ENTITY_DECODE or NONE. See docs for all supported values.
   *
   * @schema RegexMatchSetSpecInitProviderRegexMatchTuple#textTransformation
   */
  readonly textTransformation?: string;
...
/**
 * Converts an object of type 'RegexMatchSetSpecInitProviderRegexMatchTuple' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RegexMatchSetSpecInitProviderRegexMatchTuple(obj: RegexMatchSetSpecInitProviderRegexMatchTuple | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'fieldToMatch': obj.fieldToMatch?.map(y => toJson_RegexMatchSetSpecInitProviderRegexMatchTupleFieldToMatch(y)),
    'textTransformation': obj.textTransformation,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
...
/**
 * @schema RegexMatchSetSpecInitProviderRegexMatchTupleFieldToMatch
 */
export interface RegexMatchSetSpecInitProviderRegexMatchTupleFieldToMatch {
  /**
   * When type is HEADER, enter the name of the header that you want to search, e.g., User-Agent or Referer. If type is any other value, omit this field.
   *
   * @schema RegexMatchSetSpecInitProviderRegexMatchTupleFieldToMatch#data
   */
  readonly data?: string;
   ...
   * The part of the web request that you want AWS WAF to search for a specified string. e.g., HEADER, METHOD or BODY. See docs for all supported values.
   *
   * @schema RegexMatchSetSpecInitProviderRegexMatchTupleFieldToMatch#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'RegexMatchSetSpecInitProviderRegexMatchTupleFieldToMatch' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RegexMatchSetSpecInitProviderRegexMatchTupleFieldToMatch(obj: RegexMatchSetSpecInitProviderRegexMatchTupleFieldToMatch | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'data': obj.data,
    'type': obj.type,
...
export interface RegexPatternSetSpecInitProvider {
   ...
   * A list of regular expression (regex) patterns that you want AWS WAF to search for, such as B[a@]dB[o0]t.
   *
   * @schema RegexPatternSetSpecInitProvider#regexPatternStrings
   */
  readonly regexPatternStrings?: string[];
...
export interface RuleSpec {
   ...
   * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
   *
   * @schema RuleSpec#initProvider
   */
  readonly initProvider?: RuleSpecInitProvider;

  /**
   * THIS IS A BETA FIELD. It is on by default but can be opted out through a Crossplane feature flag. ManagementPolicies specify the array of actions Crossplane is allowed to take on the managed and external resources. This field is planned to replace the DeletionPolicy field in a future release. Currently, both could be set independently and non-default values would be honored if the feature flag is enabled. If both are custom, the DeletionPolicy field will be ignored. See the design doc for more information: https://github.com/crossplane/crossplane/blob/499895a25d1a1a0ba1604944ef98ac7a1a71f197/design/design-doc-observe-only-resources.md?plain=1#L223 and this one: https://github.com/crossplane/crossplane/blob/444267e84783136daa93568b364a5f01228cacbe/design/one-pager-ignore-changes.md
   *
   * @schema RuleSpec#managementPolicies
   */
  readonly managementPolicies?: RuleSpecManagementPolicies[];
...
export function toJson_RuleSpec(obj: RuleSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'initProvider': toJson_RuleSpecInitProvider(obj.initProvider),
    'managementPolicies': obj.managementPolicies?.map(y => y),
...
export interface RuleSpecForProvider {
   ...
   * The objects to include in a rule (documented below).
   *
   * @schema RuleSpecForProvider#predicates
   */
  readonly predicates?: RuleSpecForProviderPredicates[];
...
export function toJson_RuleSpecForProvider(obj: RuleSpecForProvider | undefined): Record<string, any> | undefined {
  ...
  const result = {
    'metricName': obj.metricName,
    'name': obj.name,
    'predicates': obj.predicates?.map(y => toJson_RuleSpecForProviderPredicates(y)),
    'region': obj.region,
    'tags': ((obj.tags) === undefined) ? undefined : (Object.entries(obj.tags).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
  };
  // filter undefined values
 ...
 * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
 *
 * @schema RuleSpecInitProvider
 */
export interface RuleSpecInitProvider {
  /**
   * The name or description for the Amazon CloudWatch metric of this rule. The name can contain only alphanumeric characters (A-Z, a-z, 0-9); the name can't contain whitespace.
   *
   * @schema RuleSpecInitProvider#metricName
   */
  readonly metricName?: string;
   ...
   * The name or description of the rule.
   *
   * @schema RuleSpecInitProvider#name
   */
  readonly name?: string;
   ...
   * The objects to include in a rule (documented below).
   *
   * @schema RuleSpecInitProvider#predicates
   */
  readonly predicates?: RuleSpecInitProviderPredicates[];

  /**
   * Key-value map of resource tags.
   *
   * @schema RuleSpecInitProvider#tags
   */
  readonly tags?: { [key: string]: string };
...
/**
 * Converts an object of type 'RuleSpecInitProvider' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RuleSpecInitProvider(obj: RuleSpecInitProvider | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'metricName': obj.metricName,
    'name': obj.name,
    'predicates': obj.predicates?.map(y => toJson_RuleSpecInitProviderPredicates(y)),
    'tags': ((obj.tags) === undefined) ? undefined : (Object.entries(obj.tags).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
 ...
 * A ManagementAction represents an action that the Crossplane controllers can take on an external resource.
 *
 * @schema RuleSpecManagementPolicies
 */
export enum RuleSpecManagementPolicies {
  /** Observe */
  OBSERVE = "Observe",
  /** Create */
  CREATE = "Create",
...
/**
 * @schema RuleSpecForProviderPredicates
 */
export interface RuleSpecForProviderPredicates {
  /**
   * A unique identifier for a predicate in the rule, such as Byte Match Set ID or IPSet ID.
   *
   * @schema RuleSpecForProviderPredicates#dataId
   */
  readonly dataId?: string;
   ...
   * Reference to a IPSet in waf to populate dataId.
   *
   * @schema RuleSpecForProviderPredicates#dataIdRef
   */
  readonly dataIdRef?: RuleSpecForProviderPredicatesDataIdRef;

  /**
   * Selector for a IPSet in waf to populate dataId.
   *
   * @schema RuleSpecForProviderPredicates#dataIdSelector
   */
  readonly dataIdSelector?: RuleSpecForProviderPredicatesDataIdSelector;
   ...
   *
   * @schema RuleSpecForProviderPredicates#negated
   */
  readonly negated?: boolean;
   ...
   * The type of predicate in a rule. Valid values: ByteMatch, GeoMatch, IPMatch, RegexMatch, SizeConstraint, SqlInjectionMatch, or XssMatch.
   *
   * @schema RuleSpecForProviderPredicates#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'RuleSpecForProviderPredicates' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RuleSpecForProviderPredicates(obj: RuleSpecForProviderPredicates | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'dataId': obj.dataId,
    'dataIdRef': toJson_RuleSpecForProviderPredicatesDataIdRef(obj.dataIdRef),
    'dataIdSelector': toJson_RuleSpecForProviderPredicatesDataIdSelector(obj.dataIdSelector),
    'negated': obj.negated,
    'type': obj.type,
  };
  // filter undefined values
...
/**
 * @schema RuleSpecInitProviderPredicates
 */
export interface RuleSpecInitProviderPredicates {
  /**
   * Set this to false if you want to allow, block, or count requests based on the settings in the specified waf_byte_match_set, waf_ipset, aws_waf_size_constraint_set, aws_waf_sql_injection_match_set or aws_waf_xss_match_set. For example, if an IPSet includes the IP address 192.0.2.44, AWS WAF will allow or block requests based on that IP address. If set to true, AWS WAF will allow, block, or count requests based on all IP addresses except 192.0.2.44.
   *
   * @schema RuleSpecInitProviderPredicates#negated
   */
  readonly negated?: boolean;
   ...
   * The type of predicate in a rule. Valid values: ByteMatch, GeoMatch, IPMatch, RegexMatch, SizeConstraint, SqlInjectionMatch, or XssMatch.
   *
   * @schema RuleSpecInitProviderPredicates#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'RuleSpecInitProviderPredicates' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RuleSpecInitProviderPredicates(obj: RuleSpecInitProviderPredicates | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'negated': obj.negated,
    'type': obj.type,
 ...
 * Reference to a IPSet in waf to populate dataId.
 *
 * @schema RuleSpecForProviderPredicatesDataIdRef
 */
export interface RuleSpecForProviderPredicatesDataIdRef {
  /**
   * Name of the referenced object.
   *
   * @schema RuleSpecForProviderPredicatesDataIdRef#name
   */
  readonly name: string;
   ...
   * Policies for referencing.
   *
   * @schema RuleSpecForProviderPredicatesDataIdRef#policy
   */
  readonly policy?: RuleSpecForProviderPredicatesDataIdRefPolicy;

}

/**
 * Converts an object of type 'RuleSpecForProviderPredicatesDataIdRef' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RuleSpecForProviderPredicatesDataIdRef(obj: RuleSpecForProviderPredicatesDataIdRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'policy': toJson_RuleSpecForProviderPredicatesDataIdRefPolicy(obj.policy),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Selector for a IPSet in waf to populate dataId.
 *
 * @schema RuleSpecForProviderPredicatesDataIdSelector
 */
export interface RuleSpecForProviderPredicatesDataIdSelector {
  /**
   * MatchControllerRef ensures an object with the same controller reference as the selecting object is selected.
   *
   * @schema RuleSpecForProviderPredicatesDataIdSelector#matchControllerRef
   */
  readonly matchControllerRef?: boolean;
   ...
   * MatchLabels ensures an object with matching labels is selected.
   *
   * @schema RuleSpecForProviderPredicatesDataIdSelector#matchLabels
   */
  readonly matchLabels?: { [key: string]: string };
   ...
   * Policies for selection.
   *
   * @schema RuleSpecForProviderPredicatesDataIdSelector#policy
   */
  readonly policy?: RuleSpecForProviderPredicatesDataIdSelectorPolicy;

}

/**
 * Converts an object of type 'RuleSpecForProviderPredicatesDataIdSelector' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RuleSpecForProviderPredicatesDataIdSelector(obj: RuleSpecForProviderPredicatesDataIdSelector | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'matchControllerRef': obj.matchControllerRef,
    'matchLabels': ((obj.matchLabels) === undefined) ? undefined : (Object.entries(obj.matchLabels).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
    'policy': toJson_RuleSpecForProviderPredicatesDataIdSelectorPolicy(obj.policy),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Policies for referencing.
 *
 * @schema RuleSpecForProviderPredicatesDataIdRefPolicy
 */
export interface RuleSpecForProviderPredicatesDataIdRefPolicy {
  /**
   * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
   *
   * @schema RuleSpecForProviderPredicatesDataIdRefPolicy#resolution
   */
  readonly resolution?: RuleSpecForProviderPredicatesDataIdRefPolicyResolution;

  /**
   * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
   *
   * @schema RuleSpecForProviderPredicatesDataIdRefPolicy#resolve
   */
  readonly resolve?: RuleSpecForProviderPredicatesDataIdRefPolicyResolve;

}

/**
 * Converts an object of type 'RuleSpecForProviderPredicatesDataIdRefPolicy' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RuleSpecForProviderPredicatesDataIdRefPolicy(obj: RuleSpecForProviderPredicatesDataIdRefPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'resolution': obj.resolution,
    'resolve': obj.resolve,
 ...
 * Policies for selection.
 *
 * @schema RuleSpecForProviderPredicatesDataIdSelectorPolicy
 */
export interface RuleSpecForProviderPredicatesDataIdSelectorPolicy {
  /**
   * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
   *
   * @schema RuleSpecForProviderPredicatesDataIdSelectorPolicy#resolution
   */
  readonly resolution?: RuleSpecForProviderPredicatesDataIdSelectorPolicyResolution;

  /**
   * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
   *
   * @schema RuleSpecForProviderPredicatesDataIdSelectorPolicy#resolve
   */
  readonly resolve?: RuleSpecForProviderPredicatesDataIdSelectorPolicyResolve;

}

/**
 * Converts an object of type 'RuleSpecForProviderPredicatesDataIdSelectorPolicy' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RuleSpecForProviderPredicatesDataIdSelectorPolicy(obj: RuleSpecForProviderPredicatesDataIdSelectorPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'resolution': obj.resolution,
    'resolve': obj.resolve,
 ...
 * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
 *
 * @schema RuleSpecForProviderPredicatesDataIdRefPolicyResolution
 */
export enum RuleSpecForProviderPredicatesDataIdRefPolicyResolution {
  /** Required */
  REQUIRED = "Required",
  /** Optional */
  OPTIONAL = "Optional",
 ...
 * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
 *
 * @schema RuleSpecForProviderPredicatesDataIdRefPolicyResolve
 */
export enum RuleSpecForProviderPredicatesDataIdRefPolicyResolve {
  /** Always */
  ALWAYS = "Always",
  /** IfNotPresent */
  IF_NOT_PRESENT = "IfNotPresent",
 ...
 * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
 *
 * @schema RuleSpecForProviderPredicatesDataIdSelectorPolicyResolution
 */
export enum RuleSpecForProviderPredicatesDataIdSelectorPolicyResolution {
  /** Required */
  REQUIRED = "Required",
  /** Optional */
  OPTIONAL = "Optional",
 ...
 * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
 *
 * @schema RuleSpecForProviderPredicatesDataIdSelectorPolicyResolve
 */
export enum RuleSpecForProviderPredicatesDataIdSelectorPolicyResolve {
  /** Always */
  ALWAYS = "Always",
  /** IfNotPresent */
  IF_NOT_PRESENT = "IfNotPresent",
...
export interface SizeConstraintSetSpec {
   ...
   * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
   *
   * @schema SizeConstraintSetSpec#initProvider
   */
  readonly initProvider?: SizeConstraintSetSpecInitProvider;

  /**
   * THIS IS A BETA FIELD. It is on by default but can be opted out through a Crossplane feature flag. ManagementPolicies specify the array of actions Crossplane is allowed to take on the managed and external resources. This field is planned to replace the DeletionPolicy field in a future release. Currently, both could be set independently and non-default values would be honored if the feature flag is enabled. If both are custom, the DeletionPolicy field will be ignored. See the design doc for more information: https://github.com/crossplane/crossplane/blob/499895a25d1a1a0ba1604944ef98ac7a1a71f197/design/design-doc-observe-only-resources.md?plain=1#L223 and this one: https://github.com/crossplane/crossplane/blob/444267e84783136daa93568b364a5f01228cacbe/design/one-pager-ignore-changes.md
   *
   * @schema SizeConstraintSetSpec#managementPolicies
   */
  readonly managementPolicies?: SizeConstraintSetSpecManagementPolicies[];
...
export function toJson_SizeConstraintSetSpec(obj: SizeConstraintSetSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'initProvider': toJson_SizeConstraintSetSpecInitProvider(obj.initProvider),
    'managementPolicies': obj.managementPolicies?.map(y => y),
 ...
 * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
 *
 * @schema SizeConstraintSetSpecInitProvider
 */
export interface SizeConstraintSetSpecInitProvider {
  /**
   * The name or description of the Size Constraint Set.
   *
   * @schema SizeConstraintSetSpecInitProvider#name
   */
  readonly name?: string;
   ...
   * Specifies the parts of web requests that you want to inspect the size of.
   *
   * @schema SizeConstraintSetSpecInitProvider#sizeConstraints
   */
  readonly sizeConstraints?: SizeConstraintSetSpecInitProviderSizeConstraints[];

}

/**
 * Converts an object of type 'SizeConstraintSetSpecInitProvider' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_SizeConstraintSetSpecInitProvider(obj: SizeConstraintSetSpecInitProvider | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'sizeConstraints': obj.sizeConstraints?.map(y => toJson_SizeConstraintSetSpecInitProviderSizeConstraints(y)),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * A ManagementAction represents an action that the Crossplane controllers can take on an external resource.
 *
 * @schema SizeConstraintSetSpecManagementPolicies
 */
export enum SizeConstraintSetSpecManagementPolicies {
  /** Observe */
  OBSERVE = "Observe",
  /** Create */
  CREATE = "Create",
...
/**
 * @schema SizeConstraintSetSpecInitProviderSizeConstraints
 */
export interface SizeConstraintSetSpecInitProviderSizeConstraints {
  /**
   * The type of comparison you want to perform. e.g., EQ, NE, LT, GT. See docs for all supported values.
   *
   * @schema SizeConstraintSetSpecInitProviderSizeConstraints#comparisonOperator
   */
  readonly comparisonOperator?: string;
   ...
   * Specifies where in a web request to look for the size constraint.
   *
   * @schema SizeConstraintSetSpecInitProviderSizeConstraints#fieldToMatch
   */
  readonly fieldToMatch?: SizeConstraintSetSpecInitProviderSizeConstraintsFieldToMatch[];

  /**
   * The size in bytes that you want to compare against the size of the specified field_to_match. Valid values are between 0 - 21474836480 bytes (0 - 20 GB).
   *
   * @schema SizeConstraintSetSpecInitProviderSizeConstraints#size
   */
  readonly size?: number;
   ...
   * Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the transformation on field_to_match before inspecting a request for a match. e.g., CMD_LINE, HTML_ENTITY_DECODE or NONE. See docs for all supported values. Note: if you choose BODY as type, you must choose NONE because CloudFront forwards only the first 8192 bytes for inspection.
   *
   * @schema SizeConstraintSetSpecInitProviderSizeConstraints#textTransformation
   */
  readonly textTransformation?: string;
...
/**
 * Converts an object of type 'SizeConstraintSetSpecInitProviderSizeConstraints' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_SizeConstraintSetSpecInitProviderSizeConstraints(obj: SizeConstraintSetSpecInitProviderSizeConstraints | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'comparisonOperator': obj.comparisonOperator,
    'fieldToMatch': obj.fieldToMatch?.map(y => toJson_SizeConstraintSetSpecInitProviderSizeConstraintsFieldToMatch(y)),
    'size': obj.size,
    'textTransformation': obj.textTransformation,
  };
  // filter undefined values
...
/**
 * @schema SizeConstraintSetSpecInitProviderSizeConstraintsFieldToMatch
 */
export interface SizeConstraintSetSpecInitProviderSizeConstraintsFieldToMatch {
  /**
   * When type is HEADER, enter the name of the header that you want to search, e.g., User-Agent or Referer. If type is any other value, omit this field.
   *
   * @schema SizeConstraintSetSpecInitProviderSizeConstraintsFieldToMatch#data
   */
  readonly data?: string;
   ...
   * The part of the web request that you want AWS WAF to search for a specified string. e.g., HEADER, METHOD or BODY. See docs for all supported values.
   *
   * @schema SizeConstraintSetSpecInitProviderSizeConstraintsFieldToMatch#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'SizeConstraintSetSpecInitProviderSizeConstraintsFieldToMatch' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_SizeConstraintSetSpecInitProviderSizeConstraintsFieldToMatch(obj: SizeConstraintSetSpecInitProviderSizeConstraintsFieldToMatch | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'data': obj.data,
    'type': obj.type,
...
export interface SqlInjectionMatchSetSpec {
   ...
   * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
   *
   * @schema SqlInjectionMatchSetSpec#initProvider
   */
  readonly initProvider?: SqlInjectionMatchSetSpecInitProvider;

  /**
   * THIS IS A BETA FIELD. It is on by default but can be opted out through a Crossplane feature flag. ManagementPolicies specify the array of actions Crossplane is allowed to take on the managed and external resources. This field is planned to replace the DeletionPolicy field in a future release. Currently, both could be set independently and non-default values would be honored if the feature flag is enabled. If both are custom, the DeletionPolicy field will be ignored. See the design doc for more information: https://github.com/crossplane/crossplane/blob/499895a25d1a1a0ba1604944ef98ac7a1a71f197/design/design-doc-observe-only-resources.md?plain=1#L223 and this one: https://github.com/crossplane/crossplane/blob/444267e84783136daa93568b364a5f01228cacbe/design/one-pager-ignore-changes.md
   *
   * @schema SqlInjectionMatchSetSpec#managementPolicies
   */
  readonly managementPolicies?: SqlInjectionMatchSetSpecManagementPolicies[];
...
export function toJson_SqlInjectionMatchSetSpec(obj: SqlInjectionMatchSetSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'initProvider': toJson_SqlInjectionMatchSetSpecInitProvider(obj.initProvider),
    'managementPolicies': obj.managementPolicies?.map(y => y),
...
export interface SqlInjectionMatchSetSpecForProvider {
   ...
   *
   * @schema SqlInjectionMatchSetSpecForProvider#sqlInjectionMatchTuples
   */
  readonly sqlInjectionMatchTuples?: SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuples[];
...
export function toJson_SqlInjectionMatchSetSpecForProvider(obj: SqlInjectionMatchSetSpecForProvider | undefined): Record<string, any> | undefined {
  ...
  const result = {
    'name': obj.name,
    'region': obj.region,
    'sqlInjectionMatchTuples': obj.sqlInjectionMatchTuples?.map(y => toJson_SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuples(y)),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
 *
 * @schema SqlInjectionMatchSetSpecInitProvider
 */
export interface SqlInjectionMatchSetSpecInitProvider {
  /**
   * The name or description of the SQL Injection Match Set.
   *
   * @schema SqlInjectionMatchSetSpecInitProvider#name
   */
  readonly name?: string;
   ...
   * The parts of web requests that you want AWS WAF to inspect for malicious SQL code and, if you want AWS WAF to inspect a header, the name of the header.
   *
   * @schema SqlInjectionMatchSetSpecInitProvider#sqlInjectionMatchTuples
   */
  readonly sqlInjectionMatchTuples?: SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuples[];

}

/**
 * Converts an object of type 'SqlInjectionMatchSetSpecInitProvider' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_SqlInjectionMatchSetSpecInitProvider(obj: SqlInjectionMatchSetSpecInitProvider | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'sqlInjectionMatchTuples': obj.sqlInjectionMatchTuples?.map(y => toJson_SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuples(y)),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * A ManagementAction represents an action that the Crossplane controllers can take on an external resource.
 *
 * @schema SqlInjectionMatchSetSpecManagementPolicies
 */
export enum SqlInjectionMatchSetSpecManagementPolicies {
  /** Observe */
  OBSERVE = "Observe",
  /** Create */
  CREATE = "Create",
...
/**
 * @schema SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuples
 */
export interface SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuples {
  /**
   * Specifies where in a web request to look for snippets of malicious SQL code.
   *
   * @schema SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuples#fieldToMatch
   */
  readonly fieldToMatch?: SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuplesFieldToMatch[];

  /**
   * Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the transformation on field_to_match before inspecting a request for a match. e.g., CMD_LINE, HTML_ENTITY_DECODE or NONE. See docs for all supported values.
   *
   * @schema SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuples#textTransformation
   */
  readonly textTransformation?: string;
...
/**
 * Converts an object of type 'SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuples' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuples(obj: SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuples | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'fieldToMatch': obj.fieldToMatch?.map(y => toJson_SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuplesFieldToMatch(y)),
    'textTransformation': obj.textTransformation,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
...
/**
 * @schema SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuples
 */
export interface SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuples {
  /**
   * Specifies where in a web request to look for snippets of malicious SQL code.
   *
   * @schema SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuples#fieldToMatch
   */
  readonly fieldToMatch?: SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuplesFieldToMatch[];

  /**
   * Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the transformation on field_to_match before inspecting a request for a match. e.g., CMD_LINE, HTML_ENTITY_DECODE or NONE. See docs for all supported values.
   *
   * @schema SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuples#textTransformation
   */
  readonly textTransformation?: string;
...
/**
 * Converts an object of type 'SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuples' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuples(obj: SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuples | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'fieldToMatch': obj.fieldToMatch?.map(y => toJson_SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuplesFieldToMatch(y)),
    'textTransformation': obj.textTransformation,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
...
/**
 * @schema SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuplesFieldToMatch
 */
export interface SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuplesFieldToMatch {
  /**
   * When type is HEADER, enter the name of the header that you want to search, e.g., User-Agent or Referer. If type is any other value, omit this field.
   *
   * @schema SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuplesFieldToMatch#data
   */
  readonly data?: string;
   ...
   * The part of the web request that you want AWS WAF to search for a specified string. e.g., HEADER, METHOD or BODY. See docs for all supported values.
   *
   * @schema SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuplesFieldToMatch#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuplesFieldToMatch' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuplesFieldToMatch(obj: SqlInjectionMatchSetSpecForProviderSqlInjectionMatchTuplesFieldToMatch | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'data': obj.data,
    'type': obj.type,
...
/**
 * @schema SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuplesFieldToMatch
 */
export interface SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuplesFieldToMatch {
  /**
   * When type is HEADER, enter the name of the header that you want to search, e.g., User-Agent or Referer. If type is any other value, omit this field.
   *
   * @schema SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuplesFieldToMatch#data
   */
  readonly data?: string;
   ...
   * The part of the web request that you want AWS WAF to search for a specified string. e.g., HEADER, METHOD or BODY. See docs for all supported values.
   *
   * @schema SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuplesFieldToMatch#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuplesFieldToMatch' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuplesFieldToMatch(obj: SqlInjectionMatchSetSpecInitProviderSqlInjectionMatchTuplesFieldToMatch | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'data': obj.data,
    'type': obj.type,
...
export interface WebAclSpec {
   ...
   * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
   *
   * @schema WebAclSpec#initProvider
   */
  readonly initProvider?: WebAclSpecInitProvider;

  /**
   * THIS IS A BETA FIELD. It is on by default but can be opted out through a Crossplane feature flag. ManagementPolicies specify the array of actions Crossplane is allowed to take on the managed and external resources. This field is planned to replace the DeletionPolicy field in a future release. Currently, both could be set independently and non-default values would be honored if the feature flag is enabled. If both are custom, the DeletionPolicy field will be ignored. See the design doc for more information: https://github.com/crossplane/crossplane/blob/499895a25d1a1a0ba1604944ef98ac7a1a71f197/design/design-doc-observe-only-resources.md?plain=1#L223 and this one: https://github.com/crossplane/crossplane/blob/444267e84783136daa93568b364a5f01228cacbe/design/one-pager-ignore-changes.md
   *
   * @schema WebAclSpec#managementPolicies
   */
  readonly managementPolicies?: WebAclSpecManagementPolicies[];
...
export function toJson_WebAclSpec(obj: WebAclSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'initProvider': toJson_WebAclSpecInitProvider(obj.initProvider),
    'managementPolicies': obj.managementPolicies?.map(y => y),
...
export interface WebAclSpecForProvider {
   ...
   *
   * @schema WebAclSpecForProvider#rules
   */
  readonly rules?: WebAclSpecForProviderRules[];
...
export function toJson_WebAclSpecForProvider(obj: WebAclSpecForProvider | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'name': obj.name,
    'region': obj.region,
    'rules': obj.rules?.map(y => toJson_WebAclSpecForProviderRules(y)),
    'tags': ((obj.tags) === undefined) ? undefined : (Object.entries(obj.tags).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
 ...
 * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
 *
 * @schema WebAclSpecInitProvider
 */
export interface WebAclSpecInitProvider {
  /**
   * Configuration block with action that you want AWS WAF to take when a request doesn't match the criteria in any of the rules that are associated with the web ACL. Detailed below.
   *
   * @schema WebAclSpecInitProvider#defaultAction
   */
  readonly defaultAction?: WebAclSpecInitProviderDefaultAction[];

  /**
   * Configuration block to enable WAF logging. Detailed below.
   *
   * @schema WebAclSpecInitProvider#loggingConfiguration
   */
  readonly loggingConfiguration?: WebAclSpecInitProviderLoggingConfiguration[];

  /**
   * The name or description for the Amazon CloudWatch metric of this web ACL.
   *
   * @schema WebAclSpecInitProvider#metricName
   */
  readonly metricName?: string;
   ...
   * The name or description of the web ACL.
   *
   * @schema WebAclSpecInitProvider#name
   */
  readonly name?: string;
   ...
   * Configuration blocks containing rules to associate with the web ACL and the settings for each rule. Detailed below.
   *
   * @schema WebAclSpecInitProvider#rules
   */
  readonly rules?: WebAclSpecInitProviderRules[];

  /**
   * Key-value map of resource tags.
   *
   * @schema WebAclSpecInitProvider#tags
   */
  readonly tags?: { [key: string]: string };
...
/**
 * Converts an object of type 'WebAclSpecInitProvider' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecInitProvider(obj: WebAclSpecInitProvider | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'defaultAction': obj.defaultAction?.map(y => toJson_WebAclSpecInitProviderDefaultAction(y)),
    'loggingConfiguration': obj.loggingConfiguration?.map(y => toJson_WebAclSpecInitProviderLoggingConfiguration(y)),
    'metricName': obj.metricName,
    'name': obj.name,
    'rules': obj.rules?.map(y => toJson_WebAclSpecInitProviderRules(y)),
    'tags': ((obj.tags) === undefined) ? undefined : (Object.entries(obj.tags).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
 ...
 * A ManagementAction represents an action that the Crossplane controllers can take on an external resource.
 *
 * @schema WebAclSpecManagementPolicies
 */
export enum WebAclSpecManagementPolicies {
  /** Observe */
  OBSERVE = "Observe",
  /** Create */
  CREATE = "Create",
...
/**
 * @schema WebAclSpecForProviderRules
 */
export interface WebAclSpecForProviderRules {
  /**
   ...
   *
   * @schema WebAclSpecForProviderRules#action
   */
  readonly action?: WebAclSpecForProviderRulesAction[];
   ...
   *
   * @schema WebAclSpecForProviderRules#overrideAction
   */
  readonly overrideAction?: WebAclSpecForProviderRulesOverrideAction[];
   ...
   *
   * @schema WebAclSpecForProviderRules#priority
   */
   ...
   *
   * @schema WebAclSpecForProviderRules#ruleId
   */
   ...
   *
   * @schema WebAclSpecForProviderRules#ruleIdRef
   */
  readonly ruleIdRef?: WebAclSpecForProviderRulesRuleIdRef;

  /**
   * Selector for a Rule in waf to populate ruleId.
   *
   * @schema WebAclSpecForProviderRules#ruleIdSelector
   */
  readonly ruleIdSelector?: WebAclSpecForProviderRulesRuleIdSelector;
   ...
   *
   * @schema WebAclSpecForProviderRules#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'WebAclSpecForProviderRules' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecForProviderRules(obj: WebAclSpecForProviderRules | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'action': obj.action?.map(y => toJson_WebAclSpecForProviderRulesAction(y)),
    'overrideAction': obj.overrideAction?.map(y => toJson_WebAclSpecForProviderRulesOverrideAction(y)),
    'priority': obj.priority,
    'ruleId': obj.ruleId,
    'ruleIdRef': toJson_WebAclSpecForProviderRulesRuleIdRef(obj.ruleIdRef),
    'ruleIdSelector': toJson_WebAclSpecForProviderRulesRuleIdSelector(obj.ruleIdSelector),
    'type': obj.type,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
...
/**
 * @schema WebAclSpecInitProviderDefaultAction
 */
export interface WebAclSpecInitProviderDefaultAction {
  /**
   * Specifies how you want AWS WAF to respond to requests that don't match the criteria in any of the rules. e.g., ALLOW or BLOCK
   *
   * @schema WebAclSpecInitProviderDefaultAction#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'WebAclSpecInitProviderDefaultAction' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecInitProviderDefaultAction(obj: WebAclSpecInitProviderDefaultAction | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'type': obj.type,
  };
...
/**
 * @schema WebAclSpecInitProviderLoggingConfiguration
 */
export interface WebAclSpecInitProviderLoggingConfiguration {
  /**
   * Configuration block containing parts of the request that you want redacted from the logs. Detailed below.
   *
   * @schema WebAclSpecInitProviderLoggingConfiguration#redactedFields
   */
  readonly redactedFields?: WebAclSpecInitProviderLoggingConfigurationRedactedFields[];

}

/**
 * Converts an object of type 'WebAclSpecInitProviderLoggingConfiguration' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecInitProviderLoggingConfiguration(obj: WebAclSpecInitProviderLoggingConfiguration | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'redactedFields': obj.redactedFields?.map(y => toJson_WebAclSpecInitProviderLoggingConfigurationRedactedFields(y)),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
...
/**
 * @schema WebAclSpecInitProviderRules
 */
export interface WebAclSpecInitProviderRules {
  /**
   * The action that CloudFront or AWS WAF takes when a web request matches the conditions in the rule. Not used if type is GROUP.
   *
   * @schema WebAclSpecInitProviderRules#action
   */
  readonly action?: WebAclSpecInitProviderRulesAction[];

  /**
   * Override the action that a group requests CloudFront or AWS WAF takes when a web request matches the conditions in the rule. Only used if type is GROUP.
   *
   * @schema WebAclSpecInitProviderRules#overrideAction
   */
  readonly overrideAction?: WebAclSpecInitProviderRulesOverrideAction[];

  /**
   * Specifies the order in which the rules in a WebACL are evaluated. Rules with a lower value are evaluated before rules with a higher value.
   *
   * @schema WebAclSpecInitProviderRules#priority
   */
  readonly priority?: number;
   ...
   * The rule type, either REGULAR, as defined by Rule, RATE_BASED, as defined by RateBasedRule, or GROUP, as defined by RuleGroup. The default is REGULAR. If you add a RATE_BASED rule, you need to set type as RATE_BASED. If you add a GROUP rule, you need to set type as GROUP.
   *
   * @schema WebAclSpecInitProviderRules#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'WebAclSpecInitProviderRules' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecInitProviderRules(obj: WebAclSpecInitProviderRules | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'action': obj.action?.map(y => toJson_WebAclSpecInitProviderRulesAction(y)),
    'overrideAction': obj.overrideAction?.map(y => toJson_WebAclSpecInitProviderRulesOverrideAction(y)),
    'priority': obj.priority,
    'type': obj.type,
  };
  // filter undefined values
...
/**
 * @schema WebAclSpecForProviderRulesAction
 */
export interface WebAclSpecForProviderRulesAction {
  /**
   * valid values are: BLOCK, ALLOW, or COUNT
   *
   * @schema WebAclSpecForProviderRulesAction#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'WebAclSpecForProviderRulesAction' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecForProviderRulesAction(obj: WebAclSpecForProviderRulesAction | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'type': obj.type,
  };
...
/**
 * @schema WebAclSpecForProviderRulesOverrideAction
 */
export interface WebAclSpecForProviderRulesOverrideAction {
  /**
   * valid values are: BLOCK, ALLOW, or COUNT
   *
   * @schema WebAclSpecForProviderRulesOverrideAction#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'WebAclSpecForProviderRulesOverrideAction' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecForProviderRulesOverrideAction(obj: WebAclSpecForProviderRulesOverrideAction | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'type': obj.type,
  };
 ...
 * Reference to a Rule in waf to populate ruleId.
 *
 * @schema WebAclSpecForProviderRulesRuleIdRef
 */
export interface WebAclSpecForProviderRulesRuleIdRef {
  /**
   * Name of the referenced object.
   *
   * @schema WebAclSpecForProviderRulesRuleIdRef#name
   */
  readonly name: string;
   ...
   * Policies for referencing.
   *
   * @schema WebAclSpecForProviderRulesRuleIdRef#policy
   */
  readonly policy?: WebAclSpecForProviderRulesRuleIdRefPolicy;

}

/**
 * Converts an object of type 'WebAclSpecForProviderRulesRuleIdRef' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecForProviderRulesRuleIdRef(obj: WebAclSpecForProviderRulesRuleIdRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'policy': toJson_WebAclSpecForProviderRulesRuleIdRefPolicy(obj.policy),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Selector for a Rule in waf to populate ruleId.
 *
 * @schema WebAclSpecForProviderRulesRuleIdSelector
 */
export interface WebAclSpecForProviderRulesRuleIdSelector {
  /**
   * MatchControllerRef ensures an object with the same controller reference as the selecting object is selected.
   *
   * @schema WebAclSpecForProviderRulesRuleIdSelector#matchControllerRef
   */
  readonly matchControllerRef?: boolean;
   ...
   * MatchLabels ensures an object with matching labels is selected.
   *
   * @schema WebAclSpecForProviderRulesRuleIdSelector#matchLabels
   */
  readonly matchLabels?: { [key: string]: string };
   ...
   * Policies for selection.
   *
   * @schema WebAclSpecForProviderRulesRuleIdSelector#policy
   */
  readonly policy?: WebAclSpecForProviderRulesRuleIdSelectorPolicy;

}

/**
 * Converts an object of type 'WebAclSpecForProviderRulesRuleIdSelector' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecForProviderRulesRuleIdSelector(obj: WebAclSpecForProviderRulesRuleIdSelector | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'matchControllerRef': obj.matchControllerRef,
    'matchLabels': ((obj.matchLabels) === undefined) ? undefined : (Object.entries(obj.matchLabels).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
    'policy': toJson_WebAclSpecForProviderRulesRuleIdSelectorPolicy(obj.policy),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
...
/**
 * @schema WebAclSpecInitProviderLoggingConfigurationRedactedFields
 */
export interface WebAclSpecInitProviderLoggingConfigurationRedactedFields {
  /**
   * Set of configuration blocks for fields to redact. Detailed below.
   *
   * @schema WebAclSpecInitProviderLoggingConfigurationRedactedFields#fieldToMatch
   */
  readonly fieldToMatch?: WebAclSpecInitProviderLoggingConfigurationRedactedFieldsFieldToMatch[];

}

/**
 * Converts an object of type 'WebAclSpecInitProviderLoggingConfigurationRedactedFields' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecInitProviderLoggingConfigurationRedactedFields(obj: WebAclSpecInitProviderLoggingConfigurationRedactedFields | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'fieldToMatch': obj.fieldToMatch?.map(y => toJson_WebAclSpecInitProviderLoggingConfigurationRedactedFieldsFieldToMatch(y)),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
...
/**
 * @schema WebAclSpecInitProviderRulesAction
 */
export interface WebAclSpecInitProviderRulesAction {
  /**
   * valid values are: BLOCK, ALLOW, or COUNT
   *
   * @schema WebAclSpecInitProviderRulesAction#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'WebAclSpecInitProviderRulesAction' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecInitProviderRulesAction(obj: WebAclSpecInitProviderRulesAction | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'type': obj.type,
  };
...
/**
 * @schema WebAclSpecInitProviderRulesOverrideAction
 */
export interface WebAclSpecInitProviderRulesOverrideAction {
  /**
   * valid values are: BLOCK, ALLOW, or COUNT
   *
   * @schema WebAclSpecInitProviderRulesOverrideAction#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'WebAclSpecInitProviderRulesOverrideAction' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecInitProviderRulesOverrideAction(obj: WebAclSpecInitProviderRulesOverrideAction | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'type': obj.type,
  };
 ...
 * Policies for referencing.
 *
 * @schema WebAclSpecForProviderRulesRuleIdRefPolicy
 */
export interface WebAclSpecForProviderRulesRuleIdRefPolicy {
  /**
   * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
   *
   * @schema WebAclSpecForProviderRulesRuleIdRefPolicy#resolution
   */
  readonly resolution?: WebAclSpecForProviderRulesRuleIdRefPolicyResolution;

  /**
   * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
   *
   * @schema WebAclSpecForProviderRulesRuleIdRefPolicy#resolve
   */
  readonly resolve?: WebAclSpecForProviderRulesRuleIdRefPolicyResolve;

}

/**
 * Converts an object of type 'WebAclSpecForProviderRulesRuleIdRefPolicy' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecForProviderRulesRuleIdRefPolicy(obj: WebAclSpecForProviderRulesRuleIdRefPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'resolution': obj.resolution,
    'resolve': obj.resolve,
 ...
 * Policies for selection.
 *
 * @schema WebAclSpecForProviderRulesRuleIdSelectorPolicy
 */
export interface WebAclSpecForProviderRulesRuleIdSelectorPolicy {
  /**
   * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
   *
   * @schema WebAclSpecForProviderRulesRuleIdSelectorPolicy#resolution
   */
  readonly resolution?: WebAclSpecForProviderRulesRuleIdSelectorPolicyResolution;

  /**
   * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
   *
   * @schema WebAclSpecForProviderRulesRuleIdSelectorPolicy#resolve
   */
  readonly resolve?: WebAclSpecForProviderRulesRuleIdSelectorPolicyResolve;

}

/**
 * Converts an object of type 'WebAclSpecForProviderRulesRuleIdSelectorPolicy' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecForProviderRulesRuleIdSelectorPolicy(obj: WebAclSpecForProviderRulesRuleIdSelectorPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'resolution': obj.resolution,
    'resolve': obj.resolve,
...
/**
 * @schema WebAclSpecInitProviderLoggingConfigurationRedactedFieldsFieldToMatch
 */
export interface WebAclSpecInitProviderLoggingConfigurationRedactedFieldsFieldToMatch {
  /**
   * When the value of type is HEADER, enter the name of the header that you want the WAF to search, for example, User-Agent or Referer. If the value of type is any other value, omit data.
   *
   * @schema WebAclSpecInitProviderLoggingConfigurationRedactedFieldsFieldToMatch#data
   */
  readonly data?: string;
   ...
   * valid values are: BLOCK, ALLOW, or COUNT
   *
   * @schema WebAclSpecInitProviderLoggingConfigurationRedactedFieldsFieldToMatch#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'WebAclSpecInitProviderLoggingConfigurationRedactedFieldsFieldToMatch' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_WebAclSpecInitProviderLoggingConfigurationRedactedFieldsFieldToMatch(obj: WebAclSpecInitProviderLoggingConfigurationRedactedFieldsFieldToMatch | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'data': obj.data,
    'type': obj.type,
 ...
 * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
 *
 * @schema WebAclSpecForProviderRulesRuleIdRefPolicyResolution
 */
export enum WebAclSpecForProviderRulesRuleIdRefPolicyResolution {
  /** Required */
  REQUIRED = "Required",
  /** Optional */
  OPTIONAL = "Optional",
 ...
 * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
 *
 * @schema WebAclSpecForProviderRulesRuleIdRefPolicyResolve
 */
export enum WebAclSpecForProviderRulesRuleIdRefPolicyResolve {
  /** Always */
  ALWAYS = "Always",
  /** IfNotPresent */
  IF_NOT_PRESENT = "IfNotPresent",
 ...
 * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
 *
 * @schema WebAclSpecForProviderRulesRuleIdSelectorPolicyResolution
 */
export enum WebAclSpecForProviderRulesRuleIdSelectorPolicyResolution {
  /** Required */
  REQUIRED = "Required",
  /** Optional */
  OPTIONAL = "Optional",
 ...
 * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
 *
 * @schema WebAclSpecForProviderRulesRuleIdSelectorPolicyResolve
 */
export enum WebAclSpecForProviderRulesRuleIdSelectorPolicyResolve {
  /** Always */
  ALWAYS = "Always",
  /** IfNotPresent */
  IF_NOT_PRESENT = "IfNotPresent",
...
export interface XssMatchSetSpec {
   ...
   * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
   *
   * @schema XssMatchSetSpec#initProvider
   */
  readonly initProvider?: XssMatchSetSpecInitProvider;

  /**
   * THIS IS A BETA FIELD. It is on by default but can be opted out through a Crossplane feature flag. ManagementPolicies specify the array of actions Crossplane is allowed to take on the managed and external resources. This field is planned to replace the DeletionPolicy field in a future release. Currently, both could be set independently and non-default values would be honored if the feature flag is enabled. If both are custom, the DeletionPolicy field will be ignored. See the design doc for more information: https://github.com/crossplane/crossplane/blob/499895a25d1a1a0ba1604944ef98ac7a1a71f197/design/design-doc-observe-only-resources.md?plain=1#L223 and this one: https://github.com/crossplane/crossplane/blob/444267e84783136daa93568b364a5f01228cacbe/design/one-pager-ignore-changes.md
   *
   * @schema XssMatchSetSpec#managementPolicies
   */
  readonly managementPolicies?: XssMatchSetSpecManagementPolicies[];
...
export function toJson_XssMatchSetSpec(obj: XssMatchSetSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'initProvider': toJson_XssMatchSetSpecInitProvider(obj.initProvider),
    'managementPolicies': obj.managementPolicies?.map(y => y),
...
export interface XssMatchSetSpecForProvider {
   ...
   *
   * @schema XssMatchSetSpecForProvider#xssMatchTuples
   */
  readonly xssMatchTuples?: XssMatchSetSpecForProviderXssMatchTuples[];
...
export function toJson_XssMatchSetSpecForProvider(obj: XssMatchSetSpecForProvider | undefined): Record<string, any> | undefined {
  ...
  const result = {
    'name': obj.name,
    'region': obj.region,
    'xssMatchTuples': obj.xssMatchTuples?.map(y => toJson_XssMatchSetSpecForProviderXssMatchTuples(y)),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.
 *
 * @schema XssMatchSetSpecInitProvider
 */
export interface XssMatchSetSpecInitProvider {
  /**
   * The name or description of the SizeConstraintSet.
   *
   * @schema XssMatchSetSpecInitProvider#name
   */
  readonly name?: string;
   ...
   * The parts of web requests that you want to inspect for cross-site scripting attacks.
   *
   * @schema XssMatchSetSpecInitProvider#xssMatchTuples
   */
  readonly xssMatchTuples?: XssMatchSetSpecInitProviderXssMatchTuples[];

}

/**
 * Converts an object of type 'XssMatchSetSpecInitProvider' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_XssMatchSetSpecInitProvider(obj: XssMatchSetSpecInitProvider | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'xssMatchTuples': obj.xssMatchTuples?.map(y => toJson_XssMatchSetSpecInitProviderXssMatchTuples(y)),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * A ManagementAction represents an action that the Crossplane controllers can take on an external resource.
 *
 * @schema XssMatchSetSpecManagementPolicies
 */
export enum XssMatchSetSpecManagementPolicies {
  /** Observe */
  OBSERVE = "Observe",
  /** Create */
  CREATE = "Create",
...
/**
 * @schema XssMatchSetSpecForProviderXssMatchTuples
 */
export interface XssMatchSetSpecForProviderXssMatchTuples {
  /**
   * Specifies where in a web request to look for cross-site scripting attacks.
   *
   * @schema XssMatchSetSpecForProviderXssMatchTuples#fieldToMatch
   */
  readonly fieldToMatch?: XssMatchSetSpecForProviderXssMatchTuplesFieldToMatch[];

  /**
   * Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the transformation on target_string before inspecting a request for a match. e.g., CMD_LINE, HTML_ENTITY_DECODE or NONE. See docs for all supported values.
   *
   * @schema XssMatchSetSpecForProviderXssMatchTuples#textTransformation
   */
  readonly textTransformation?: string;
...
/**
 * Converts an object of type 'XssMatchSetSpecForProviderXssMatchTuples' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_XssMatchSetSpecForProviderXssMatchTuples(obj: XssMatchSetSpecForProviderXssMatchTuples | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'fieldToMatch': obj.fieldToMatch?.map(y => toJson_XssMatchSetSpecForProviderXssMatchTuplesFieldToMatch(y)),
    'textTransformation': obj.textTransformation,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
...
/**
 * @schema XssMatchSetSpecInitProviderXssMatchTuples
 */
export interface XssMatchSetSpecInitProviderXssMatchTuples {
  /**
   * Specifies where in a web request to look for cross-site scripting attacks.
   *
   * @schema XssMatchSetSpecInitProviderXssMatchTuples#fieldToMatch
   */
  readonly fieldToMatch?: XssMatchSetSpecInitProviderXssMatchTuplesFieldToMatch[];

  /**
   * Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the transformation on target_string before inspecting a request for a match. e.g., CMD_LINE, HTML_ENTITY_DECODE or NONE. See docs for all supported values.
   *
   * @schema XssMatchSetSpecInitProviderXssMatchTuples#textTransformation
   */
  readonly textTransformation?: string;
...
/**
 * Converts an object of type 'XssMatchSetSpecInitProviderXssMatchTuples' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_XssMatchSetSpecInitProviderXssMatchTuples(obj: XssMatchSetSpecInitProviderXssMatchTuples | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'fieldToMatch': obj.fieldToMatch?.map(y => toJson_XssMatchSetSpecInitProviderXssMatchTuplesFieldToMatch(y)),
    'textTransformation': obj.textTransformation,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
...
/**
 * @schema XssMatchSetSpecForProviderXssMatchTuplesFieldToMatch
 */
export interface XssMatchSetSpecForProviderXssMatchTuplesFieldToMatch {
  /**
   * When type is HEADER, enter the name of the header that you want to search, e.g., User-Agent or Referer. If type is any other value, omit this field.
   *
   * @schema XssMatchSetSpecForProviderXssMatchTuplesFieldToMatch#data
   */
  readonly data?: string;
   ...
   * The part of the web request that you want AWS WAF to search for a specified string. e.g., HEADER, METHOD or BODY. See docs for all supported values.
   *
   * @schema XssMatchSetSpecForProviderXssMatchTuplesFieldToMatch#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'XssMatchSetSpecForProviderXssMatchTuplesFieldToMatch' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_XssMatchSetSpecForProviderXssMatchTuplesFieldToMatch(obj: XssMatchSetSpecForProviderXssMatchTuplesFieldToMatch | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'data': obj.data,
    'type': obj.type,
...
/**
 * @schema XssMatchSetSpecInitProviderXssMatchTuplesFieldToMatch
 */
export interface XssMatchSetSpecInitProviderXssMatchTuplesFieldToMatch {
  /**
   * When type is HEADER, enter the name of the header that you want to search, e.g., User-Agent or Referer. If type is any other value, omit this field.
   *
   * @schema XssMatchSetSpecInitProviderXssMatchTuplesFieldToMatch#data
   */
  readonly data?: string;
   ...
   * The part of the web request that you want AWS WAF to search for a specified string. e.g., HEADER, METHOD or BODY. See docs for all supported values.
   *
   * @schema XssMatchSetSpecInitProviderXssMatchTuplesFieldToMatch#type
   */
  readonly type?: string;
...
/**
 * Converts an object of type 'XssMatchSetSpecInitProviderXssMatchTuplesFieldToMatch' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_XssMatchSetSpecInitProviderXssMatchTuplesFieldToMatch(obj: XssMatchSetSpecInitProviderXssMatchTuplesFieldToMatch | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'data': obj.data,
    'type': obj.type,
